...
function! before#spacevim#filemanager#coc_explorer() abort 
  ...
  call add(g:coc_extensions,'coc-explorer')
...
" [ NOTE ] the integration here is a bit buggy.
" I recommend using coc_explorer instead.
...
function! before#spacevim#filemanager#chadtree() abort 
  ...
  let g:spacevim_filetree_direction=""
  let g:spacevim_enable_vimfiler_gitstatus=""
  " call add(g:spacevim_custom_plugins,['ms-jpq/chadtree',{ 'branch' : 'chad','build':'python3 -m pip install chadtree && python3 -m chadtree deps'}])
  call add(g:spacevim_custom_plugins,['ms-jpq/chadtree',{ 'rev' : 'chad','hook_post_source':'silent CHADdeps'}])
  " call add(g:spacevim_custom_plugins,['ms-jpq/chadtree',{ 'rev' : 'chad'}])
  " call add(g:spacevim_custom_plugins,['ms-jpq/chadtree',{ 'branch' : 'chad'}])
