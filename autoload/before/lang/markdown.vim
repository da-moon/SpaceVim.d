function! before#lang#markdown#bootstrap()
  call SpaceVim#logger#info("[ before#lang#markdown#bootstrap ] function called.")
    ...
    call add(g:coc_extensions,'coc-markdownlint')
    call SpaceVim#custom#LangSPCGroupName('markdown', ['C','m'], '+Coc-markdown')
...
function! before#lang#markdown#coc_reveal()
  ...
  call add(g:coc_extensions,'coc-reveal')
  call SpaceVim#custom#LangSPC('markdown', 'nmap', ['C' ,'m', 'r'], '<plug>(coc-reveal-it)', 'create-slides-from-the-whole-file', 0)
  call SpaceVim#custom#LangSPC('markdown', 'vmap', ['C' ,'m', 'r'], '<plug>(coc-reveal-it-v)', 'create-slides-from-the-selected-lines', 0)
...
function! before#lang#markdown#coc_markmap()
  ...
  call add(g:coc_extensions,'coc-markmap')
  call SpaceVim#custom#LangSPC('markdown', 'nmap', ['C' ,'m', 'm'], '<plug>(coc-markmap-create)', 'create-markmap-from-the-whole-file', 0)
  call SpaceVim#custom#LangSPC('markdown', 'vmap', ['C' ,'m', 'm'], '<plug>(coc-markmap-create-v)', 'create-markmap-from-the-selected-lines', 0)
...
function! before#lang#markdown#vim_table_mode()
  ...
  " call SpaceVim#custom#LangSPC('markdown', 'nmap', [',','t'], 'TableModeToggle', 'create-table', 0)
endfunction
